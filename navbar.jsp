...
<div class="container-fluid">
  ...
  <a class="navbar-brand" href="/"><h3 class="text-color"><i>Rapid Dine...</i></h3></a>
      ...
      <div class="modal-body">
        ...
        <p style="font-size:20px;">
          <b>
            ...
            At Rapid Dine, we're passionate about revolutionizing the food ordering experience. Our mission is to provide an efficient and seamless platform for both customers and restaurants to connect, order, and enjoy delicious meals with ease.
            
            With Rapid Dine, customers can browse through a diverse selection of restaurants, explore enticing menus, and place orders effortlessly through our user-friendly Android app and website. Whether it's a quick bite on-the-go or a leisurely dining experience at home, Rapid Dine caters to every palate and preference.
            
            For restaurant partners, Rapid Dine offers a comprehensive solution to streamline operations and enhance customer satisfaction. From efficient order management to seamless communication, our platform empowers restaurants to deliver exceptional service and drive business growth.
            
            We understand the importance of innovation and continuously strive to enhance our platform with cutting-edge features and functionalities. With a commitment to excellence and customer-centricity, Rapid Dine is your ultimate destination for convenient and delightful food ordering experiences.
            
            Join us in embracing the future of dining. Welcome to Rapid Dine – where ordering food is as quick and easy as a click!"
          </b>
        </p>
        </div>
      </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size:23px;">
            <b>
                <img src="resources/images/phonee.png" style="width:27px;" alt="img">+91 9307409740 / +91 8308300882<br>
                <img src="resources/images/emaill.png" style="width:29px;" alt="img">mahak@gmail.com
            </b>
        </p>
        </div>
      </div>
